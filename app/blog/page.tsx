...
export const metadata={title:"NEXRIG Guides | Gaming PC, Hardware & Build Tips",description:"Panduan gaming PC Indonesia: processor, GPU, RAM, SSD, PSU, monitor, compatibility, dan build guide berdasarkan budget."};
